...
alias mpf='make -j LINTFAST PRODUCT=ANTARES'
alias ma='make -j PRODUCT=ANTARES | ccmsgfilter'
alias md='make -j PRODUCT=DELPHI | ccmsgfilter'
...
alias mcal='make -j PRODUCT=CALIMINI | ccmsgfilter'
alias mmp5='make -j PRODUCT=MP5 | ccmsgfilter'
alias mmsp='make -j PRODUCT=MMSPLUS | ccmsgfilter'
alias mcp='make -j PRODUCT=CARDIAC_PL | ccmsgfilter'
